<?php
/**
 * Script para insertar preformatos de ejemplo en la base de datos PostgreSQL
 */
...
try {
    ...
    error_log("[" . date('Y-m-d H:i:s') . "] Error en insertar_preformatos.php: " . $e->getMessage(), 3, "c:/laragon/www/clinica/logs/database.log");
}
?>
